...
angular.module('localization', [])
    ...
    .provider('localize', function localizeProvider() {
        ...
        this.languages = ['de','en','fr','it','ru','ja','sv'];
        ...
        this.$get = ['$http', '$rootScope', '$window', '$filter', function ($http, $rootScope, $window, $filter) {
            ...
            var localize = {
                ...
                buildUrl: function() {
                    ...
                    return '/json/localization_' + localize.language + '.' + provider.ext + '?v=VERSION';
                },
                ...
                initLocalizedResources:function () {
                    ...
                    $http({ method:"GET", url:url, cache:false }).success(localize.successCallback).error(function () {
                        ...
                        var url = 'json/localization_en' + '.' + provider.ext + '?v=VERSION';
    ...
    .filter('i18n', ['localize', function (localize) {
        function localizeFilter (input) {
            return localize.getLocalizedString(input);
        }
        localizeFilter.$stateful = true;
